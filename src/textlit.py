...
def LoadText(sinput):
    with open(sinput, "r") as text_files:
...
def ExportText(output, data):
    ...
    with open("output/AICOPY"+textpath[b-9:b], "w") as text_file:
...
def rundis(userinput):
    ...
    for i in range(1, iterations):
        ...
        textpath = str(userinput)
        b = len(textpath)
        sophie_brain = open("log-files/log" + textpath[b - 9:b], "w")
